...
///
/// In general, use `UnitySwiftProtobuf.Message` instead when you need a variable or
/// argument that can hold any type of message. Occasionally, you can use
/// `UnitySwiftProtobuf.Message & Equatable` or `UnitySwiftProtobuf.Message & Hashable` as
